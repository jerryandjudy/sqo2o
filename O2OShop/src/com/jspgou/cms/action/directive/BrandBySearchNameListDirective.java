...
* @preserve
*/
public class BrandBySearchNameListDirective extends WebDirective {
	/**
	 * 模板名称
	 */
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		String searchName=this.getString("searchName", params);
		//List<Brand> list = categoryMng.getBrandByCate(categoryId);
		List<Brand> list = categoryMng.getBrandByCateSearchName(searchName);
