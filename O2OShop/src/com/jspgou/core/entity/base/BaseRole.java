...
/**
 * This is an object that contains data related to the jc_core_role table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 * 
 * @hibernate.class table="jc_core_role" This class should preserve.
 * @preserve
 */
...
public abstract class BaseRole implements Serializable {
	...
	public BaseRole(java.lang.Integer id, java.lang.String name,
			java.lang.Integer priority, java.lang.Boolean m_super) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.jspgou.core.entity.Role))
			return false;
		else {
