...
import com.tencent.utils.Sha1Util;
import com.tencent.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wxfa9dc9b226c4968e";
	private static String appsecret = "00c7b3b11f40dc56817ced66796c43b9";
	private static String partner = "1258993201";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "Elite888888888888888888888888888";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "liuwang123ok";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://www.nhaocang.com";																	 // Key
	...
	public static String getCodeurl(WxPayDto tpWxPayDto){
		...
		return new GetWxOrderno().getCodeUrl(createOrderURL, xml).getMsg();
	}
