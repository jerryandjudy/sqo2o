...
define("tabs", [ "zepto.extend.touch", "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector" ], function(require, exports, module) {
    ...
    function amTabs(parent) {
        var $tabsContent = parent.find(".am-tabs-bd-content00"), $tabsDiv = $tabsContent.children(), oneWidth, iNow = 0, disX, disY, downY, downX, $tabLi = parent.find(".am-tabs-hd00").children();
        //设置tabsdiv宽度
        ...
        $tabsContent.swipeRight(function() {
            ...
            $tabLi.removeClass("am-tabs-hd-active00");
            $tabLi.eq(iNow).addClass("am-tabs-hd-active00");
        });
