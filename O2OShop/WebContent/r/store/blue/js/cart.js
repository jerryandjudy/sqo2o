...
function decrement(base,itemId,j){
	...
	$("#total_market_items_"+e+"_"+index).html(parseFloat(mk)*c);
	$("#total_sale_items_"+e+"_"+index).html('');
	$("#total_sale_items_"+e+"_"+index).html(parseFloat(sl)*c);
	$("#total_weight_items_"+e+"_"+index).html('');
	$("#total_weight_items_"+e+"_"+index).html(parseFloat(dweight)*c);
	$("#total_score_items_"+e+"_"+index).html('');
	$("#total_score_items_"+e+"_"+index).html(parseInt(score)*c);
	aa();
...
function calSubTotal(base,itemId,i,h,g,score,dj,dweight){
	...
	var score=$("#score_items_"+e+"_"+index).html();
	$("#total_market_items_"+e+"_"+index).html('');
	$("#total_market_items_"+e+"_"+index).html(parseFloat(mk)*a);
	$("#total_sale_items_"+e+"_"+index).html('');
	$("#total_sale_items_"+e+"_"+index).html(parseFloat(sl)*a);
	$("#total_weight_items_"+e+"_"+index).html('');
	$("#total_weight_items_"+e+"_"+index).html(parseFloat(dweight)*a);
	$("#total_score_items_"+e+"_"+index).html('');
	$("#total_score_items_"+e+"_"+index).html(parseInt(score)*a);
	aa();
	$.post(base+"/cart/ajaxUpdateCartItem.jspx", {
		'cartItemId' : itemId,
		'count':a
